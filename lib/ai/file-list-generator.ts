...
const FILE_LIST_SYSTEM_PROMPT = `You are a full-stack architect. Given a prompt and blueprint, enumerate EVERY file the project needs — 20 to 200 files.
...
function getDefaultManifestFiles(): ManifestFile[] {
  const defaults: Array<{ path: string; type: FileType; description: string; priority: number }> = [
    ...
    { path: 'components/Footer.tsx', type: 'component', description: 'Page footer', priority: 3 },
