...
export default function JobsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", color: "#fff", fontFamily: "system-ui, sans-serif", padding: 32 }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 800, margin: "16px 0 4px" }}>⚙️ Job Queue Monitor</h1>
      <p style={{ color: "#888", marginBottom: 32 }}>Distributed background jobs, scheduling & retry logic.</p>
