...
export default function AcademyPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a", color: "#fff", fontFamily: "system-ui, sans-serif", padding: 32 }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 800, margin: "16px 0 4px" }}>🎓 AI Academy</h1>
      <p style={{ color: "#888", marginBottom: 32 }}>Interactive courses, certifications & leaderboards.</p>
