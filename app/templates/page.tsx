...
const TEMPLATES: Template[] = [
  ...
  { name: "Ride Sharing App", description: "Uber-like ride sharing with maps and real-time tracking", icon: "🚗", category: "Marketplace", complexity: "Complex", prompt: "Build a ride-sharing app like Uber with a map view showing available drivers, ride booking flow, driver dashboard with earnings, and real-time trip status updates using Supabase realtime." },
  { name: "Food Delivery", description: "DoorDash-style food ordering and delivery platform", icon: "🍔", category: "Marketplace", complexity: "Complex", prompt: "Build a food delivery app with restaurant listings, menu items with images and prices, cart and checkout, order tracking page, and restaurant admin panel." },
  { name: "SaaS App", description: "Full SaaS with billing, teams, and settings", icon: "💼", category: "SaaS", complexity: "Complex", prompt: "Build a SaaS application with a marketing landing page, user onboarding, subscription plans with Stripe billing, team workspace management, and account settings." },
  { name: "AI Chat App", description: "ChatGPT-style AI chat with history and personas", icon: "🤖", category: "AI", complexity: "Complex", prompt: "Build an AI chat application with a sidebar showing conversation history, multiple AI personas/system prompts, markdown message rendering, code syntax highlighting, and message regeneration." },
  { name: "Booking System", description: "Calendly-style appointment booking", icon: "📅", category: "Productivity", complexity: "Medium", prompt: "Build an appointment booking system with a calendar view, time slot availability, booking confirmation email flow, admin dashboard to manage appointments, and customer booking history." },
];
