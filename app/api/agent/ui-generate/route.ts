...
export async function POST(req: Request) {
  try {
    ...
    const { projectId, description, componentName, existingFiles, options } = body;
    ...
    const result = await agent.generate({ projectId, description, componentName, existingFiles, options });
